    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geometry', django.contrib.gis.db.models.fields.MultiPolygonField(help_text=b'The geographic boundary', srid=4326, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geometry', django.contrib.gis.db.models.fields.MultiPolygonField(help_text=b'The geographic boundary', srid=4326, null=True, blank=True)),
                ('id', models.AutoField(serialize=False, primary_key=True)),
                ('slug', models.SlugField(max_length=100, unique=True, serialize=False)),
